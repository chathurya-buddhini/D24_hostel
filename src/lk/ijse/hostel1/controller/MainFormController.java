...
import lk.ijse.hostel1.util.Navigation;
import lk.ijse.hostel1.util.Routes;
...
public class MainFormController {
    ...
    public void onActionLogOut(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader=new FXMLLoader(getClass().getResource("/lk/ijse/hostel1/view/LoginForm.fxml"));
