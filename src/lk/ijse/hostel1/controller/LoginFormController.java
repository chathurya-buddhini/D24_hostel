...
import lk.ijse.hostel1.util.Notification;
...
public class LoginFormController implements Initializable {
    ...
    public void btnSign(ActionEvent actionEvent) throws IOException {
        ...
        if (checkUserDetail ()){
            ...
            stage.setScene(new Scene (FXMLLoader.load(getClass().getResource("/lk/ijse/hostel1/view/MainForm.fxml"))));
...
*/
        FXMLLoader fxmlLoader=new FXMLLoader(getClass().getResource("/lk/ijse/hostel1/view/MainAdminForm.fxml"));
